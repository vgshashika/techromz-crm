              ...
              <Grid container size={12} sx={{ justifyContent: 'center' }}>
                <Grid size={8}>
                  ...
                  >
                    ...
                    >
                      Manage customers, sales, teams, and workflows from one powerful platform. Boost productivity, automate daily tasks, and grow your business with an all-in-one CRM solution built for modern companies.
                    </Typography>
                  </motion.div>
                </Grid>
              </Grid>
