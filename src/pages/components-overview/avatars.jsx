            ...
            <Stack sx={{ gap: GRID_COMMON_SPACING }}>
              ...
              <MainCard title="Vector" codeString={vectorAvatarCodeString}>
                <Grid container spacing={1}>
                  <Grid>
                    <Avatar>
                      <CardMedia component="img" sx={{ height: 40 }} alt="Vector 1" src={vector1} />
                    </Avatar>
                  </Grid>
                  <Grid>
                    <Avatar>
                      <CardMedia component="img" sx={{ height: 40 }} alt="Vector 2" src={vector2} />
                    </Avatar>
                  </Grid>
                  <Grid>
                    <Avatar>
                      <CardMedia component="img" sx={{ height: 40 }} alt="Vector 3" src={vector3} />
                    </Avatar>
                  </Grid>
                  <Grid>
                    <Avatar>
                      <CardMedia component="img" sx={{ height: 40 }} alt="Vector 4" src={vector4} />
                    </Avatar>
                  </Grid>
                </Grid>
              </MainCard>
